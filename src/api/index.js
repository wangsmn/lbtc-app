...
// 查询各类型某月每天报警数量(折线图)
export const queryPoliceTypeNum = (data) => post(`${baseURL}/zx/queryPoliceTypeNum`, data);
...
export const queryZxDeviceNumByUserId = (data) => post(`${baseURL}/zx/queryZxDeviceNumByUserId`, data);
